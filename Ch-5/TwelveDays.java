...
public class TwelveDays {
          public static void main(String[] args) {
                    ...
                    if (christmas == 1) {
                              System.out.println("On the " + christmas
                                                  + "st day of Christmas, my true love sent to me,");
                    }
                    if (christmas == 2) {
                              System.out.println("On the " + christmas
                                                  + "nd day of Christmas, my true love sent to me,");
                    }
                    if (christmas == 3) {
                              System.out.println("On the " + christmas
                                                  + "rd day of Christmas, my true love sent to me,");
                    }
                    if (christmas != 1 && christmas != 2 && christmas != 3 && christmas <= 12) {
                              System.out.println("On the " + christmas
                                                  + "th day of Christmas, my true love sent to me,");
                    }
                    if (christmas > 12) {
